  ...
  return (
    <section className="relative z-10 my-16 mx-5 max-w-[1200px] md:flex md:items-center md:gap-5 xl:mx-auto">
      ...
      <div className=" flex flex-col gap-2 mt-5 md:w-full md:mt-0 md:flex-1 md:pl-5">
       <div className=" h-16 md:h-24 w-4/5  md:ml-8 lg:ml-16 lg:w-4/6 bg-artist bg-top bg-cover rounded-lg "></div>
       <div className=" h-16 md:h-24 lg:mr-14  w-4/6 rounded-lg self-end  bg-artist bg-center bg-cover"></div>
       <div className=" h-16 md:h-24 rounded-lg w-4/5 ml-5 md:ml-8 lg:ml-16 lg:w-4/6 bg-artist bg-bottom bg-cover"></div>
      </div>
