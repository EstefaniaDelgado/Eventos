  ...
  return (
    <section className="relative z-10 my-16 mx-5 max-w-[1200px] md:flex md:items-center md:gap-5 xl:mx-auto">
      <div className="pt-5 md:pt-8 lg:pt-16 xl:pt-24 flex flex-col justify-end items-start gap-5 md:flex-1 md:order-1 md:pl-5 xl:p-5 ">
       ...
       <div className="z-50">
       <h3 className="font-light z-50 text-lg md:text-xl font-title text-purple">
          [ Sobre el Evento ]
        </h3>
        <h2 className="z-50 font-semibold text-2xl md:text-3xl ">Bienvenido a los mejores eventos para terminar muy bien el 2024</h2>
       </div>
